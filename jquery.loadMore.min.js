(function ($, i, j, k) {
  ...
  $.fn.loadMore = function (d) {
    var e = $(
      "<div class='_loadMore-imgLoading'><img src='" +
        l +
        "images/load.gif'><span class='loadText'>Loading...</span></div>"
    );
    ...
    function Load() {
      this.init = function (a) {
        ...
        var c = $(
          '<link href="' + l + 'jquery.loadMore.css" rel="stylesheet">'
        );
        $("head").append(c);
      };
    }
    Load.prototype = {
      ...
      noAjax: function () {
        ...
        if (
          (running =
            false && contentH - viewH - scrollTopH <= opts.scrollBottom)
        ) {
          running = true;
          opts.callback();
          running = false;
    ...
    var h = new Load();
    h.init(this);
    return { updatePram: h.updatePram };
  };
  function getPath() {
    var a = j.scripts,
      b = a[a.length - 1].src;
